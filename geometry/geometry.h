...
Map_Coords screen_to_map_k_0 (Screen_Coords sc) {
    ...
    mc.i = (sc.x - SCREEN_WIDTH/2.0) * POINTS_PER_PIXEL / 2 
         + (sc.y - SCREEN_HEIGHT/2.0) * POINTS_PER_PIXEL * ISOMETRIC_FACTOR / 2
         + (mc.k - viewpoint.k) * ISOMETRIC_FACTOR / 2
         + viewpoint.i;
     
    mc.j = (sc.x - SCREEN_WIDTH/2.0) * POINTS_PER_PIXEL / 2
         - (sc.y - SCREEN_HEIGHT/2.0) * POINTS_PER_PIXEL * ISOMETRIC_FACTOR / 2
         - (mc.k - viewpoint.k) * ISOMETRIC_FACTOR / 2
         + viewpoint.j;
...
int update_bicubic_coefficients(Tile_Coords tile){  //TODO untested
    ...
    left_matrix[0][0] =  0.0;
    left_matrix[0][1] = -1.0/3.0;
    left_matrix[0][2] =  1.0/2.0;
    left_matrix[0][3] = -1.0/6.0;
    
    left_matrix[1][0] =  1.0;
    left_matrix[1][1] = -1.0/2.0;
    left_matrix[1][2] = -1.0;
    left_matrix[1][3] =  1.0/2.0;
    
    left_matrix[2][0] =  0.0;
    left_matrix[2][1] =  1.0;
    left_matrix[2][2] =  1.0/2.0;
    left_matrix[2][3] = -1.0/2.0;
    
    left_matrix[3][0] =  0.0;
    left_matrix[3][1] = -1.0/6.0;
    left_matrix[3][2] =  0.0;
    left_matrix[3][3] =  1.0/6.0;
