...
//we want to divide by tile size in points, always rounding down.
    ...
    square.i = floordiv (map.i, POINTS_PER_PIXEL * PIXELS_PER_TILE * TILES_PER_SQUARE);
    square.j = floordiv (map.j, POINTS_PER_PIXEL * PIXELS_PER_TILE * TILES_PER_SQUARE);
    square.k = map.k;
...
//TODO is this the right order for checking top or bottom?
...
/*
int update_bicubic_coefficients(bbTileCoords tile){  //TODO deprecated
...
int map_coords_get_elevation_bicubic(bbMapCoords mc){   //TODO deprecated
...
Float_3d map_coords_get_normal_bicubic(bbMapCoords mc){   //TODO deprecated
