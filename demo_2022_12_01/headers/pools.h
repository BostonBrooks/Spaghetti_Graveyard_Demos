...
\
    extern CLASS* CONCAT2(CLASS, _Pool)[LEVEL_1];\
\
    extern int CONCAT2(CLASS, _Available_Head) = -1;\
    extern int CONCAT2(CLASS, _Available_Tail) = -1;\
\
    extern int CONCAT2(CLASS, _In_Use_Head) = -1;\
    extern int CONCAT2(CLASS, _In_Use_Tail) = -1;\
\
    extern int CONCAT2(CLASS, _Make_NULL)(void);\
\
    extern int CONCAT2(CLASS, _New)(int);\
    extern int CONCAT2(CLASS, _Delete)(int Address);\
\
    extern int CONCAT2(CLASS, _Increase_Pool)(int Level1_Address);\
\
    extern CLASS* CONCAT2(CLASS, s)(int Address);\
    extern CLASS* CONCAT2(CLASS, s_sudo)(int Address);\
...
//DECLARE all of the functions used by the pool
...
//DEFINE all of the globals and functions used by the pool
